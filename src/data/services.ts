...
export const servicePages: ServicePage[] = [
  {
    ...
    intro: [
      "A vessel and rig agent is the appointed local representative for a ship, rig or offshore unit in port, transiting through territorial waters or stopping at anchorage: handling port and customs clearance, berth scheduling and port-authority liaison, immigration and crew changes, husbandry and owners' protective agency, bunkering, dry docking and repairs, procurement, coordination and full mobilisation/demobilisation. Afrishore acts as full vessel and rig agent for rigs, drillships, semi-submersibles, OSVs, PSVs, AHTS, tankers and FPSOs across its licensed Southern African port network.",
