...
export const servicePages: ServicePage[] = [
  {
    ...
    intro: [
      "Afrishore holds its own port agency licences at Saldanha, Durban, Mossel Bay and Cape Town in South Africa, and at Lüderitz and Walvis Bay in Namibia — operating as a full ship, vessel and rig agency for rigs, drillships, semi-submersibles, OSVs, PSVs, AHTS, tankers, FPSOs and passenger liners. From a single accountable point of contact, every call is cleared and operational on arrival.",
      "Vessel and rig agency in this region is unforgiving: tight berthing windows, complex immigration for international crews, customs and classification-society deadlines, and weather that does not wait. Afrishore's embedded teams — permanently inside the Port of Walvis Bay's Oil & Gas Section and across the South African coast — handle port clearance, berth scheduling and port-authority liaison, immigration compliance, dry docking and repairs coordination, bunkering arrangements, procurement and a technical support network, and full husbandry, so the master and the operator deal with one agent rather than a chain of subcontractors.",
